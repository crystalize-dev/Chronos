...
const ForgotPage: React.FC = () => {
    ...
    return (
        ...
        >
            <Icon
                className="lg:border-light-border lg:dark:border-dark-border absolute left-4 top-4 !size-8 rounded-md border-solid bg-light-bg p-1 lg:-left-12 lg:top-4 lg:border dark:bg-dark-bg dark:text-white"
                icon="arrowLeft"
                onClick={() => router.back()}
            />
